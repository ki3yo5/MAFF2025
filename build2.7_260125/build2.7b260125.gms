...
* set import scenario (0=baseline(0%), 1=20%, 2=40%, 3=60%, 4=100%):
...
parameter
    ...
    allow(pattern,c) = 1;
*Common for "rice_wheat" and "potato"
...
*Residual land per month (croppable in "paddy_dry" or "field_irr" and other region than "Hokkaido") 
    resLand(pattern,r,l,t) $((sameas(l,'paddy_dry') or sameas(l,'field_irr')) and (not sameas(r,'Hokkaido'))) = land_endw(r,l)
                                     - sum(c, pxrlcrop(pattern,c,r,l)*landreq_CRT(c,r,t));
